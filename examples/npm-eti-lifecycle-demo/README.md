...
nono run --no-diagnostics --profile demo-npm-supply-chain -- npm install --ignore-scripts --cache /tmp/nono-demo/npm-cache --logs-dir /tmp/nono-demo/npm-cache/_logs
```
...
nono run --no-diagnostics --profile demo-npm-supply-chain -- npm install --foreground-scripts --cache /tmp/nono-demo/npm-cache --logs-dir /tmp/nono-demo/npm-cache/_logs
```
