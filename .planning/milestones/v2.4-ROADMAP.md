...
- 🏗️ **v2.4 Complete the Partial Ports + UPST4** — Phases 35–40, incl. optional 36.5 (Phases 37 + 38 re-anchored to v2.5 at close 2026-05-15)
...
### 🏗️ v2.4 Complete the Partial Ports + UPST4 (Phases 35–40, incl. optional 36.5; Phases 37 + 38 re-anchored to v2.5 at close 2026-05-15) — CLOSING
...
- ⤴ **Phase 37: v2.3 carry-forward Linux/macOS execution** — re-anchored to v2.5 at v2.4 close 2026-05-15. Linux/macOS host did not become available during v2.4. REQ-RESL-NIX-01..03 + REQ-PKGS-04 carry forward; REQ-PKGS-01 re-marked Complete via v2.3 Phase 26-02 production code. See `## v2.5 backlog` § Phase 37.
- ⤴ **Phase 38: REQ-AAH-01 native host re-validation (optional)** — re-anchored to v2.5 at v2.4 close 2026-05-15. Depends on Phase 37 host availability; optional. See `## v2.5 backlog` § Phase 38.
