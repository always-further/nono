...
Session IDs use the format `YYYYMMDD-HHMMSS-PID` (e.g., `20260214-143022-12345`). Windows preview-era sessions may also appear as `windows-preview-<pid>-<timestamp>`, and nono treats both formats as valid when detecting stale sessions.
