...
pub struct Profile {
    ...
    /// Directory names to skip when scanning or snapshotting.
    /// Treated like built-in heavy directories (e.g. target, node_modules).
    /// Matched as exact path component names. Additive with --skip-dir.
    #[serde(default)]
